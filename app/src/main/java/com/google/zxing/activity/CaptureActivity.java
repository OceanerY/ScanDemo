...
import com.yangs.scandemo.BaseActivity;
import com.yangs.scandemo.R;
import com.yangs.scandemo.util.Constant;
import com.yangs.scandemo.util.UriUtil;
...
public class CaptureActivity extends BaseActivity implements Callback {
    ...
    private View.OnClickListener albumOnClick = new View.OnClickListener() {
        ...
        public void onClick(View view) {
            //打开手机中的相册
            performCodeWithPermission("相册", new PermissionCallback() {
                @Override
                ...
                public void noPermission() {
                    Toast.makeText(CaptureActivity.this, "相册暂时不可用！", Toast.LENGTH_SHORT).show();
                }
